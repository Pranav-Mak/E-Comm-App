...
router.post('/add', authMiddleware, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const productId = req.body.productId;
        const userId = req.body.user.mainId2;
        try {
            const existingEntry = yield prisma.cart.findUnique({
                where: {
                    userId_productId: {
...
router.get('/', authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.body.user.mainId2;
    try {
        const mycart = yield prisma.cart.findMany({
            where: {
                userId: parseInt(userId)
            },
            include: {
...
router.delete('/', authMiddleware, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const productId = req.body.productId;
        try {
            const remove = yield prisma.cart.delete({
                where: {
                    userId_productId: {
                        userId: parseInt(userId),
                        productId: parseInt(productId)
